...
def user_input():
    ...
    if object_check["config_file"] != "":
        ...
        parser.add_argument("-la", "--language", default=False, help="Defines the language filter", type=str, required=False)
        ...
        parser.add_argument("-cd", "--chromedriver", help="specify the path to chromedriver executable", type=str, required=False)
        ...
        parser.add_argument("-sa", "--safe_search", default=False, help="Turns on the safe search filter", action="store_true")
        ...
        parser.add_argument("-sil", "--silent_mode", default=False, help="Remains silent", action="store_true")
        parser.add_argument("-is", "--save_source", help="creates a text file containing a list of downloaded images", type=str, required=False)
...
class googleimagesdownload:
    ...
    def download_extended_page(self, url, chromedriver):
        # Selenium usage if needed
        return self.download_page(url)

    # Rest of the implementation (simplified for brevity or kept if necessary)
    # Since this is a helper, we should keep it functional but clean of circular imports.
