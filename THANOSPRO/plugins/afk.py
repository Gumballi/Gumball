...
async def set_not_afk(event):
    ...
    if "#" not in current_message and gvarstat("AFK") == "YES":
        ...
        try:
            await unsave_gif(event, THANOSPRO)
            delgvar("AFK")
            ...
            await event.client.send_message(
                ...
                + f" Ask in {rishu_grp} to get help!",
                reply_to=event.message.id,
                link_preview=False,
                silent=True,
            )
        await asyncio.sleep(5)
        await THANOSPRO.delete()
        afk_time_1 = None
...
async def on_afk(event):
    ...
    if gvarstat("AFK") == "YES" and not (await event.get_sender()).bot:
        ...
        msg = await event.reply(message_to_reply, file=rishupic_1)
        try:
...
async def _(event):
    ...
    owo = event.text[5:]
    reason_1 = owo
    rishupic_1 = await event.client.download_media(krakenop)
    if gvarstat("AFK") != "YES":
        ...
        if owo == "":
            ...
            x = await event.client.send_message(
                event.chat_id, f"**I'm going afk🚶**", file=rishupic_1)
            try:
                await unsave_gif(event, x)
                xy = await event.client.send_message(
                    Config.LOGGER_ID,
                    f"#AFKTRUE \n**AFK mode** = `True`\n**Reason:** `Not Mentioned`", file=rishupic_1
                    )
                try:
            ...
            addgvar("AFK", "YES")
            x = await event.client.send_message(
                event.chat_id, f"**I'm going afk🚶**\n\n**Because :** `{reason_1}`", file=rishupic_1)
            try:
                await unsave_gif(event, x)
                xy = await event.client.send_message(
                    Config.LOGGER_ID,
                    f"#AFKTRUE \n**AFK mode** = `True`\n**Reason:** `{reason_1}`", file=rishupic_1
                    )
                try:
                    await unsave_gif(event, xy)
                except:
...
if H2:
    ...
    async def on_afk(event):
        ...
        if gvarstat("AFK2") == "YES" and not (await event.get_sender()).bot:
            ...
            msg = await event.reply(message_to_reply, file=rishupic_2)
            try:
                await unsave_gif(event, msg)
            except:
                pass
    ...
    async def _(event):
        ...
        owo = event.text[5:]
        reason_2 = owo
        rishupic_2 = await event.client.download_media(krakenop)
        if not gvarstat("AFK2"):
            ...
            if owo == "":
                addgvar("AFK2", "YES")
                x = await event.client.send_message(
                    event.chat_id, f"**I'm going afk🚶**", file=rishupic_2)
                try:
                    await unsave_gif(event, x)
                    xy = await event.client.send_message(
                        Config.LOGGER_ID,
                        f"#AFKTRUE \n**AFK mode** = `True`\n**Reason:** `Not Mentioned`",file=rishupic_2
                        )
                    try:
                        await unsave_gif(event, xy)
                    except:
                ...
                addgvar("AFK2", "YES")
                x = await event.client.send_message(
                    event.chat_id, f"**I'm going afk🚶**\n\n**Because :** `{reason_2}`", file=rishupic_2)
                try:
                    await unsave_gif(event, x)
                    xy = await event.client.send_message(
                        Config.LOGGER_ID,
                        f"#AFKTRUE \n**AFK mode** = `True`\n**Reason:** `{reason_2}`",file=rishupic_2
                        )
                    try:
                        await unsave_gif(event, xy)
                    except:
...
if H3:
    ...
    async def on_afk(event):
        ...
        if gvarstat("AFK3") == "YES" and not (await event.get_sender()).bot:
            ...
            msg = await event.reply(message_to_reply, file=rishupic_3)
            try:
                await unsave_gif(event, msg)
            except:
                pass
    ...
    async def _(event):
        ...
        owo = event.text[5:]
        reason_3 = owo
        rishupic_3 = await event.client.download_media(krakenop)
        if not gvarstat("AFK3"):
            ...
            if owo == "":
                addgvar("AFK3", "YES")
                x = await event.client.send_message(
                    event.chat_id, f"**I'm going afk🚶**", file=rishupic_3)
                try:
                    await unsave_gif(event, x)
                    xy = await event.client.send_message(
                        Config.LOGGER_ID,
                        f"#AFKTRUE \n**AFK mode** = `True`\n**Reason:** `Not Mentioned`",file=rishupic_3
                        )
                    try:
                        await unsave_gif(event, xy)
                    except:
                ...
                addgvar("AFK3", "YES")
                x = await event.client.send_message(
                    event.chat_id, f"**I'm going afk🚶**\n\n**Because :** `{reason_3}`", file=rishupic_3)
                try:
                    await unsave_gif(event, x)
                    xy = await event.client.send_message(
                        Config.LOGGER_ID,
                        f"#AFKTRUE \n**AFK mode** = `True`\n**Reason:** `{reason_3}`",file=rishupic_3
                        )
                    try:
                        await unsave_gif(event, xy)
                    except:
...
if H4:
    ...
    async def on_afk(event):
        ...
        if gvarstat("AFK4") == "YES" and not (await event.get_sender()).bot:
            ...
            msg = await event.reply(message_to_reply, file=rishupic_4)
            try:
                await unsave_gif(event, msg)
            except:
                pass
    ...
    async def _(event):
        ...
        owo = event.text[5:]
        reason_4 = owo
        rishupic_4 = await event.client.download_media(krakenop)
        if not gvarstat("AFK4"):
            ...
            if owo == "":
                addgvar("AFK4", "YES")
                x = await event.client.send_message(
                    event.chat_id, f"**I'm going afk🚶**", file=rishupic_4)
                try:
                    await unsave_gif(event, x)
                    xy = await event.client.send_message(
                        Config.LOGGER_ID,
                        f"#AFKTRUE \n**AFK mode** = `True`\n**Reason:** `Not Mentioned`",file=rishupic_4
                        )
                    try:
                        await unsave_gif(event, xy)
                    except:
                ...
                addgvar("AFK4", "YES")
                x = await event.client.send_message(
                    event.chat_id, f"**I'm going afk🚶**\n\n**Because :** `{reason_4}`", file=rishupic_4)
                try:
                    await unsave_gif(event, x)
                    xy = await event.client.send_message(
                        Config.LOGGER_ID,
                        f"#AFKTRUE \n**AFK mode** = `True`\n**Reason:** `{reason_4}`",file=rishupic_4
                        )
                    try:
                        await unsave_gif(event, xy)
                    except:
...
if H5:
    ...
    async def on_afk(event):
        ...
        if gvarstat("AFK5") == "YES" and not (await event.get_sender()).bot:
            ...
            msg = await event.reply(message_to_reply, file=rishupic_5)
            try:
                await unsave_gif(event, msg)
            except:
                pass
    ...
    async def _(event):
        ...
        owo = event.text[5:]
        reason_5 = owo
        rishupic_5 = await event.client.download_media(krakenop)
        if not gvarstat("AFK5"):
            ...
            if owo == "":
                addgvar("AFK5", "YES")
                x = await event.client.send_message(
                    event.chat_id, f"**I'm going afk🚶**", file=rishupic_5)
                try:
                    await unsave_gif(event, x)
                    xy = await event.client.send_message(
                        Config.LOGGER_ID,
                        f"#AFKTRUE \n**AFK mode** = `True`\n**Reason:** `Not Mentioned`",file=rishupic_5
                        )
                    try:
                        await unsave_gif(event, xy)
                    except:
                ...
                addgvar("AFK5", "YES")
                x = await event.client.send_message(
                    event.chat_id, f"**I'm going afk🚶**\n\n**Because :** `{reason_5}`", file=rishupic_5)
                try:
                    await unsave_gif(event, x)
                    xy = await event.client.send_message(
                        Config.LOGGER_ID,
                        f"#AFKTRUE \n**AFK mode** = `True`\n**Reason:** `{reason_5}`",file=rishupic_5
                        )
                    try:
                        await unsave_gif(event, xy)
                    except:
